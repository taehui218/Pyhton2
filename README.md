...
조건문은 처음엔 구조가 헷갈렸지만, 실제 예제를 따라하며 점점 이해가 되었습니다.
특히 elif나 else를 쓸 때 들여쓰기를 잘못하면 오류가 나기 쉬워서 신경을 많이 써야 했습니다.
하지만 흐름을 직접 제어할 수 있다는 점이 재미있었고, 앞으로 더 복잡한 프로그램을 만들 수 있을 것 같아 기대됩니다.
